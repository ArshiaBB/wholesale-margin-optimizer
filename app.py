...
<style>
    ...
    /* Style the Metric Cards like Power BI */
...
# --- ENTERPRISE LAYOUT: TABS ---
tab_finance, tab_inventory, tab_forecast = st.tabs([
    "💰 1. Financial Overview", 
    "📦 2. Inventory AI (EOQ & ABC)", 
...
with tab_inventory:
    # (کدهای مربوط به ABC Treemap، Loss makers و فرمول رادیکال EOQ رو اینجا بذار)
...
with tab_forecast:
    # (کدهای مربوط به XGBoost، نمودار سری زمانی و پیش‌بینی ۱۴ روزه رو اینجا بذار)
